            ...
            <div class="card shadow-lg rounded-4 p-4 bg-white dark:bg-gray-800">
                ...
                <form action="{{ route('admin.guides.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Image --}}
                        <div class="col-md-6">
                            <label for="image" class="form-label text-gray-700 dark:text-gray-300">Image du guide (optionnel)</label>
                            <input type="file"
                                   id="image"
                                   name="image"
