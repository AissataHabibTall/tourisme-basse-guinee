        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="card shadow-lg rounded-4 p-4 bg-white dark:bg-gray-800">
                <h2 class="card-title mb-4 text-center text-2xl font-bold text-gray-800 dark:text-white">
                    Modifier le lieu : {{ $lieu->nom }}
                </h2>

                <form action="{{ route('admin.lieux.update', $lieu->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01"
                                   id="tarifEntree"
                                   name="tarifEntree"
                                   value="{{ old('tarifEntree', $lieu->tarifEntree) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('horairesOuverture', $lieu->horairesOuverture) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   id="accessibilite"
                                   name="accessibilite"
                                   value="{{ old('accessibilite', $lieu->accessibilite) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description"
                                      ...
                                      required>{{ old('description', $lieu->description) }}</textarea>
                            @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        {{-- Image principale --}}
                        <div class="col-md-6">
                            <label for="image" class="form-label text-gray-700 dark:text-gray-300">Image principale (laisser vide pour conserver)</label>
                            <input type="file"
                                   id="image"
                                   name="image"
                            ...
                            @if($lieu->image)
                                <img src="{{ asset('storage/' . $lieu->image) }}" alt="Image du lieu" class="mt-2 rounded-md max-w-xs">
                            @endif
                        </div>
