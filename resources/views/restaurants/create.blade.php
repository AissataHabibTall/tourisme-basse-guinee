            ...
            <div class="card shadow-lg rounded-4 p-4 bg-white dark:bg-gray-800">
                ...
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Galerie d'images --}}
                        <div class="col-md-6">
                            <label for="galerie_images_restaurant" class="form-label text-gray-700 dark:text-gray-300">Galerie d’images (facultatif)</label>
                            <input type="file"
